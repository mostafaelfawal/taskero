...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="flex min-h-screen">
      ...
      <div className="relative flex-1 hidden lg:block bg-linear-to-tl from-transparent via-transparent to-violet-200">
        <Image
          src="/authImage.png"
          alt="auth image"
          fill
        ...
        <div className="absolute bottom-0 flex flex-col justify-center p-12">
